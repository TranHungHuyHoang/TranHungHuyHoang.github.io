...
#Đường dẫn đến thư viện Font Awesome để sử dụng biểu tượng.
...
<body>
    <!--Navigation bar-->
    #Hiển thị thông báo lỗi (error) hoặc thông báo thành công (success) nếu có.
    ...
    <!--Navbar-->
    #Nếu người dùng chưa đăng nhập, sử dụng file nav_guest.php để hiển thị navbar tương ứng.
    <?php
    ...
    <section id="login-container">
        ...
        <div class="wrapper">
            <div class="form">
                #Form đăng nhập gửi dữ liệu đến login_processing.php để xử lý.
                    ...
                    <div class="flex-mode">
                        ...
                        <div>
                            <label class="switch switch-light">
                                # Ô chọn loại người dùng (staff hoặc user).
    ...
    <!--Footer-->
    #Thẻ <footer> chứa thông tin về bản quyền và tác giả
...
# Đường dẫn đến file JavaScript (input_validate.js) để thực hiện các hàm kiểm tra nhập liệu.
