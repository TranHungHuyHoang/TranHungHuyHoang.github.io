<?php
    ...
    // Check connection
    $dbname = "electro";
    $conn = mysqli_connect($servername, $user_name, $password);#Kiểm tra và thiết lập kết nối đến cơ sở dữ liệu:
    ...
    if (!$conn)
        die("Connection failed: " . mysqli_connect_error());#Kiểm tra kết nối và xuất lỗi nếu có

    #Khởi tạo một số mật khẩu đã được băm
...
#Thực hiện các lệnh INSERT thông qua mysqli_multi_query
    mysqli_close($conn);
