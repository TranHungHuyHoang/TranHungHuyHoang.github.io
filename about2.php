...
<body>
    ...
    <section id="about-us">
        ...
        <div class="about-text">
            <h2>Location</h2>
            <p><b>shool</b><br>
            459 Tôn Đức Thắng, Hoà Khánh Nam, Liên Chiểu, Đà Nẵng 550000, Việt Nam
            <p>
            <p><b>Branch</b><br>
            48 Mẹ Suốt, Hoà Khánh Nam, Liên Chiểu, Đà Nẵng 550000, Việt Nam
            <p>
        </div>
    </section>
    <section id="cd-google-map" style="margin-bottom: 4rem;">
        ...
        <address>459 Tôn Đức Thắng, Hoà Khánh Nam, Liên Chiểu, Đà Nẵng 550000, Việt Nam</address> 
    </section>
    <!--Footer-->
    <?php
