    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="user_index.php<?php  ?>">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="user_index.php<?php  ?>">Product</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="about.php?id=<?php ?>">About</a> 
                </li>
            </ul>
            <div class="mx-auto">
                ...
                <li class="nav-item" style="margin-right: 2rem;">
                    <div class="dropdown show">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg-end animate slideIn shopping-cart" role="menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a href="./libs/cart.php" class="checkout-button">Payment</a>
                        </div>
                    </div>
                </li>
                <li class="nav-item">
