...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 14, 2023 lúc 06:51 PM
...
--
-- Đang đổ dữ liệu cho bảng `shopping_session`
--

INSERT INTO `shopping_session` (`id`, `user_id`, `total`, `created_at`) VALUES
(1, NULL, '0', '2021-12-02 20:41:36'),
(2, 6, '499', '2023-12-14 17:48:09');
...
(1,'xanhadmin','12345678','Xanh','Nguyen','2023-12-16 03:58:29');
-- --------------------------------------------------------
...
(6, 'xanh1234', '$2y$10$YdpdQiLHoiCQk06pui62YOmxaxibgeIDFOMk8k5zZ.U6KIBi3Micu', 'xanh', 'nguyen', NULL, NULL, '2003-01-01', '2023-12-13 14:18:05');
